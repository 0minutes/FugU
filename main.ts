...
const shell = (): number =>
{
    ...
    while (true)
    {
        ...
        const parser: Parser = new Parser('<stdin>', input); 
        const typeChecker: TypeChecker =  new TypeChecker(parser, Env);
        
        const generator = new BytecodeGenerator(parser);
        
        console.log(parser.ast);
        
        typeChecker.checkGlobal();

        console.log(generator.generateGlobal())
    };
};
